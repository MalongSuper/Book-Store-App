...
sys.path.insert(0, os.path.join(BASE_DIR, "db setup"))
sys.path.insert(0, os.path.join(BASE_DIR, "json"))
...
def book_preview(title):
    ...
    with open(os.path.join(BASE_DIR, "templates", "books_data.json")) as f:
        books = json.load(f)
...
def view_coupon():
    ...
    with open(os.path.join(BASE_DIR, "templates", "coupon.json"), 'r') as f:
